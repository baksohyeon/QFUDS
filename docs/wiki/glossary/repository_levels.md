...
When any of these files are next edited, link the first level mention to this
glossary:

- [AGENTS.md](../../../AGENTS.md)
- [PROJECT.md](../../../PROJECT.md)
- [README.md](../../../README.md)
- [docs/00_project/README.md](../../00_project/README.md)
...
Code comments and generated outputs also contain level terms, but they are not
primary backlink targets unless those comments are being maintained as reader
documentation. Generated outputs are non-authoritative for glossary purposes.

Recommended backlink target: this glossary. Adjust the relative path by
directory, and use the link text `repository level` or `repository levels`.
