---
doc_id: zkqv_cbe73dc53569
title: "ZK Queue - 모델 바꾸려면: ... config:set qfuds-fiction GEMINI_MODEL=gemini-3.5-flash"
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - 모델 바꾸려면: ... config:set qfuds-fiction GEMINI_MODEL=gemini-3.5-flash
