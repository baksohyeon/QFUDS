---
doc_id: zkqv_ba1867abf9ce
title: ZK Queue - 텔링 모드 규약 (이 파일 전용)
doc_type: reference
stage: reference
status: draft
...
- Source line: [line 56](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/20_drafts/1.5부/031_origin_sael_webnovel_storyboard_ko.md)
- Heading level: `H2`
- Source heading: `텔링 모드 규약 (이 파일 전용)`
