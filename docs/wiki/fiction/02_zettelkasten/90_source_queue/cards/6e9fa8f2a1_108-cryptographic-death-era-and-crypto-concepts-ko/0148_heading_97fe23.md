---
doc_id: zkqv_97fe230ca9ab
title: ZK Queue - PART B. 암호 개념 상세 사전 (사용자 학습 노트 → SAGA)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - PART B. 암호 개념 상세 사전 (사용자 학습 노트 → SAGA)
...
- Source line: [line 148](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/108_cryptographic_death_era_and_crypto_concepts_ko.md)
- Heading level: `H1`
- Source heading: `PART B. 암호 개념 상세 사전 (사용자 학습 노트 → SAGA)`
