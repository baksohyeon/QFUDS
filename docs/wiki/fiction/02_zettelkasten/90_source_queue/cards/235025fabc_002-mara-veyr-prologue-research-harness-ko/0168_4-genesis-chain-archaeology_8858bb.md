---
doc_id: zkqv_8858bb1f7f73
title: ZK Queue - 4. Genesis Chain Archaeology
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - 4. Genesis Chain Archaeology
...
- Source line: [line 168](../../../../../../../docs/wiki/fiction/90_archive/qfuds-saga_pre_reboot_planning/00_workroom/002_mara_veyr_prologue_research_harness_ko.md)
- Heading level: `H3`
- Source heading: `4. Genesis Chain Archaeology`

## Parent Context

- H1: QFUDS SAGA Mara Veyr 프롤로그 연구 하네스
- H2: Social Background
