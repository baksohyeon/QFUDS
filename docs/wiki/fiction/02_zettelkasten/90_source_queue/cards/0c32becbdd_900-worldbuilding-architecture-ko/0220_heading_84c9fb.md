---
doc_id: zkqv_84c9fbbc24b3
title: ZK Queue - 3.2 캐릭터 Layered Architecture (의도된 층 분리)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - 3.2 캐릭터 Layered Architecture (의도된 층 분리)
...
- Source line: [line 220](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/00_continuity/900_worldbuilding_architecture_ko.md)
- Heading level: `H3`
- Source heading: `3.2 캐릭터 Layered Architecture (의도된 층 분리)`
