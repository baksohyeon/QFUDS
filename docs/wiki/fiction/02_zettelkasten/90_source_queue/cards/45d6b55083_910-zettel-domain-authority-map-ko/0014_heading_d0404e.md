---
doc_id: zkqv_d0404e39db7c
title: ZK Queue - 캐논 권위는 도메인별로 갈린다
doc_type: reference
stage: reference
status: draft
evidence_role: provenance
depends_on:
  - qfuds_verse_zettel_domain_authority_map_ko
next_gate: process this queue card into an atomic permanent zettel or mark it as source-only
last_updated: 2026-07-07
---

# ZK Queue - 캐논 권위는 도메인별로 갈린다
...
- Source line: [line 14](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/00_continuity/910_zettel_domain_authority_map_ko.md)
- Heading level: `H1`
- Source heading: `캐논 권위는 도메인별로 갈린다`
