---
doc_id: zkqv_4e47dc4a511c
title: ZK Queue - `.agent/templates/fiction/` 사용 상태
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - `.agent/templates/fiction/` 사용 상태
...
- Source line: `51`
- Heading level: `H2`
- Source heading: ``.agent/templates/fiction/` 사용 상태`
