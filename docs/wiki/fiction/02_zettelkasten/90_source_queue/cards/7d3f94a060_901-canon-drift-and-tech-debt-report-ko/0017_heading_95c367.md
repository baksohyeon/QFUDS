---
doc_id: zkqv_95c367b295f5
title: ZK Queue - QFUDS Verse Canon Drift·Tech Debt 리포트 (드리프트 원장·중복·리팩터 우선순위)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - QFUDS Verse Canon Drift·Tech Debt 리포트 (드리프트 원장·중복·리팩터 우선순위)
...
- Source line: [line 17](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/00_continuity/901_canon_drift_and_tech_debt_report_ko.md)
- Heading level: `H1`
- Source heading: `QFUDS Verse Canon Drift·Tech Debt 리포트 (드리프트 원장·중복·리팩터 우선순위)`
