---
doc_id: zkqv_c693bd87dfd5
title: ZK Queue - `40_release` — 출간 후보·내보내기 (게이트 통과 후)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - `40_release` — 출간 후보·내보내기 (게이트 통과 후)
...
- Source line: [line 827](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/000_saga_encyclopedia_ko.md)
- Heading level: `H3`
