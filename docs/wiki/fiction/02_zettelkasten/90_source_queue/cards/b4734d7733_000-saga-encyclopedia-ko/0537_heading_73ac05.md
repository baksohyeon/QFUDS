---
doc_id: zkqv_73ac052dbbc9
title: ZK Queue - QFUDS SAGA 작가 사유 렌즈 — 압축·SSOT·동기화 + Soft Editing 텍스처
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - QFUDS SAGA 작가 사유 렌즈 — 압축·SSOT·동기화 + Soft Editing 텍스처
...
- Source line: [line 537](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/000_saga_encyclopedia_ko.md)
- Heading level: `H4`
- Source heading: `[QFUDS SAGA 작가 사유 렌즈 — 압축·SSOT·동기화 + Soft Editing 텍스처](00_bible/204_authorial_lenses_compression_ssot_soft_editing_ko.md)`
