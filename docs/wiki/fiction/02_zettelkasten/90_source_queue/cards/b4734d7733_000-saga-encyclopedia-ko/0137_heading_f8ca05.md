---
doc_id: zkqv_f8ca055b6e37
title: ZK Queue - QFUDS SAGA origin(1.5부) 사엘 풀길이 소설 (한국어 primary)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - QFUDS SAGA origin(1.5부) 사엘 풀길이 소설 (한국어 primary)
...
- Source line: [line 137](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/000_saga_encyclopedia_ko.md)
- Heading level: `H4`
- Source heading: `[QFUDS SAGA origin(1.5부) 사엘 풀길이 소설 (한국어 primary)](20_drafts/1.5부/033_origin_sael_full_novel_korean_primary.md)`
