---
doc_id: zkqv_8d8fe4e0ed4c
title: ZK Queue - QFUDS SAGA Truth-State Ledger (인물·독자·세계 지식 상태 원장)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - QFUDS SAGA Truth-State Ledger (인물·독자·세계 지식 상태 원장)
...
- Source line: [line 790](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/000_saga_encyclopedia_ko.md)
- Heading level: `H4`
- Source heading: `[QFUDS SAGA Truth-State Ledger (인물·독자·세계 지식 상태 원장)](00_workroom/413_truth_state_ledger_ko.md)`
