...
1. QFUDS SAGA 1부 [029 active reboot manuscript](../10_universes/qfuds-verse/20_series/qfuds-saga/20_drafts/029_first_arc_book1_reboot_korean_primary.md)에서 [007 GSD phase brief](../10_universes/qfuds-verse/20_series/qfuds-saga/00_workroom/007_first_arc_book1_gsd_phase_brief_ko.md)의 hard floor를 지키며 Chapter 3 `The Last Hodler`를 이어 쓴다.
