---
doc_id: qfuds_saga_identity_flood_revised_v2_korean_adaptation_v3snapshot
...
벽에 떠 있던 앞선 표식들이 차례로 흐려졌다. `RECOVERABLE / NOT CLAIMABLE`은 돌아온
사람을 이름 붙였지만, 그 옆에 끌려온 산 사람까지는 잡지 못해 회색으로 바랬다.
`ACCESS != AUTHORITY`는 이제 방 안에 접근보다 많은 것이 들어차자 빛을 잃었다.
`NO CONSENT BY ANALOGY`는 유추가 범람으로 불어나면서 가장자리부터 지워졌다.
...
탐욕이 손잡이를 하나 더 얻어요. Aletheia는 그걸 알고도 등록부를 더 채워 왔습니다."
