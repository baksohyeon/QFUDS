...
숫자 행진은 없었다. 이름 셋과, 체계가 각자에게서 판본을 하나보다 많이 찾아냈다는
사실만 있었다. 판본이란 한 사람한테서 복원해 낼 수 있는 데이터 사본이었다. 한 사람의
신원에서 쓸 수 있는 사본이 여럿 떨어져 나온다는 뜻이고, 그 사본 하나하나가 따로
청구당할 수 있었다.
...
그 점이 Liora를 가장 싫게 했다. 차라리 협박이었다면 반려하면 그만이었다.

04:40, 중앙 증거 홀에는 판사 셋, 변호인 다섯, 복원 수학자
둘, 봉인된 방청석, 동결된 항소 통로 스물하나, Mara Veyr, Noor Aram,
Tamas와 그의 어머니, Ione이 모여 있었다. 그리고 호환 가능한 자아들, 곧 사람마다 딸려
나온 판본 사본들이 살아 있는 사람 수보다 많았다. 그 탓에 홀 안의 누구나 자기 자신이
과소 집계된 것처럼 느낄 지경이었다.

이번에 바닥에는 창백한 시신 군대가 없었다.

Liora가 영사된 상을 증인 고리로 접으라고 명령했기 때문이다. 명령을 입력하는
동안 키패드가 손끝 아래에서 미지근했다. 흩어진 데이터 사본이 한 사람당 하나씩, 빛으로
그린 둥근 테두리 안으로 빨려 들어가 모였다. 그 테 하나가 그 사람의 증인 고리였다.
Mara의 고리. Noor의 고리. Tamas의 고리. Sela Daur의 고리. 네 개의 빛 테가
바닥 위에 떠서 나란히 돌았다. 각 고리 안에는 기억, 혈연, 관할, 잔여물, 서명, 누락,
강압 위험이 겹쳐진 선으로 나타났다.
...
빈칸을 메우도록 길들여진 기계에게 모욕이었으니까. Liora는 자기도 그 글을 읽고 싶어
한다는 걸 알아차렸고, 그 충동에 정의라는 이름표가 얼마나 쉽게 붙는지도 알아차렸다.
...
사건철의 호환 사본이 하나 늘 때마다, 그 옆에 새 줄이 돋았다. 청구할 각도, 개선할 각도,
보호할 각도, 완성하고 상속하고 전시하고 소송할 각도. 본인은 그렇게 늘려 달라고 한 적이
없었다.

Liora는 따뜻한 칸에서 깎지 않은 토막을 꺼냈다. 손바닥에 묵직했고, 끝이 아직
거칠었다.

Laur 교관들은 공개적으로 법을 만들어 내지 말라고 가르쳤다. 그렇게 한 감사관들이
나중에 어떤 위원회에 끌려갔는지도 가르쳤다. 그녀는 그 이름들을 기억했다.
...
붉은 선이 글자 위로 한 번 지나갔다. 사건철은 손으로 쓴 표식을 좋아하지 않았다.
그녀는 토막을 종이에 그대로 둔 채 끝까지 눌렀고, 잉크가 붉은 선 밑으로 배어들 때까지
밀어붙였다. 글자가 남았다.
