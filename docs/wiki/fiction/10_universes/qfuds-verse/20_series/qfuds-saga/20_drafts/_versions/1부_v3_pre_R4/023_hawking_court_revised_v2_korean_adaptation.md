---
doc_id: qfuds_saga_hawking_court_revised_v2_korean_adaptation_v3snapshot
...
나중에 Ministry가 H-1이라 부르게 될 그 어두운 실가닥도 아니었다. 무기에 서류
캐비닛 같은 이름을 붙이는 사람들의 그 메마른 안도감도, Liora가 처음 기억한 것은
아니었다.
...
"큰 사건은 국가의 복원입니다. 법정이 key와 graph, 편지, 신뢰 경로까지 되살릴 수
있다면, 결국 우주 자체가 죽은 자를 되살릴 만큼의 기록을 어딘가 남겨 두는지 물어야
합니다. 블랙홀이 그 기록을 흘린다면, 그건 법정이 읽을 수 있는 증거입니다."

블랙홀이 흘린 신호끼리 어떻게 얽혀 있는지를 보면, 거기 빨려든 것들의 흔적이 일부
남아 있다는 게 그쪽 주장이었다. Liora는 그 말이 얼마나 매끄럽게 사람을 무덤 쪽으로
미는지 헤아렸다.
...
다 타고 남은, 블랙홀에 가까운 무거운 덩어리다. H-1은 그 잔해가 흘린 신호를 거꾸로
풀어 보겠다는 한 조각이었다.

"떨어져 들어간 것을 부분적으로 되짚는 데 도움이 될 수 있습니다."
...
interpretive lattice는 그 신호를 읽어 내는 해석 격자, 곧 계산의 틀이었다. 그리고 그
틀이 기대고 선 오래된 단어가 의례 없이 심리실에 들어왔다.

QFUDS.

우주는 정보를 잃지 않고 어딘가에 흘려 둘 뿐이라고, 그래서 충분히 모으기만 하면 잃은
상태를 되짚을 수 있다고 본 이론의 이름이다. 증명된 적은 없다. 검증된 적도, 재현된
적도, 학계가 다시 받아들인 적도 없다. 다만 망가진 기계 몇 대에는 얄궂게 잘 들어맞아서,
그래선 안 될 사람들까지 홀려 버리는 폐기된 셈법이었다.
...
"복원 가능한 상태 가족은 증언이 아닙니다. 제약된 사전 확률은 동의가 아닙니다. 상관
묶음은 증인이 아닙니다. 금지된 해석 격자는 죽은 기계를 쓸모 있게 만든다고 해서
진실이 되지는 않습니다."
...
"Veil은 분리를 요청합니다. 사후 동의 기준이 다시 쓰이기 전까지, 치밀 천체 복원
