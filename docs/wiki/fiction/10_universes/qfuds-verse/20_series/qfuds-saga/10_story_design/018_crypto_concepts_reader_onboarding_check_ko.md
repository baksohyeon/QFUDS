...
| --- | --- | --- | --- |
| public key | 017 B1 threat / B3 threat, 029 prologue에 이미 교육 화면 있음 | “서명하면 공개키가 장부에 뜬다”를 정확한 설명 → 주소/열쇠 비유 → 전송/보류 비용으로 보여줌 | B1에서 3단 온보딩 필요 |
...
| TODO | 대상 | 필요도 |
| --- | --- | --- |
| B1 첫 화면에 public key / signature / ledger의 정확한 기술 설명을 짧게 넣는다 | 017 B1 또는 원고 intent card | release-blocking |
| B1 안에서 주소/열쇠 비유로 공개키/개인키/Q-Day를 일반 독자가 잡게 한다 | 017 B1 또는 원고 intent card | release-blocking |
| B1 선택 압력을 “전송=노출 / 보류=증발”로 고정한다 | 017 B1 또는 원고 intent card | release-blocking |
