...
next_gate: user approves arc length + ep3-6 direction, then write 028 Korean primary
...
합의인가([008 반전 설계](008_last_archive_reveal_architecture_ko.md)).
...
| --- | --- | --- | --- | --- | --- |
| 1 | [025](../20_drafts/025_who_may_author_loss_korean_primary.md) | 누가 상실을 쓸 수 있는가 | 보호가 접수창구·상품이 됨; 복원 불가자는 빈칸도 없음 | `UNRECOVERED IS NOT UNREAL` | 완료(A) |
| 2 | [027](../20_drafts/027_who_may_refuse_korean_primary.md) | 누가 거부할 수 있는가 | 거부 등록부가 자격 문턱이 됨; Liora의 마크가 청구 손잡이로 변질 | `REFUSAL IS NOT A PRIVILEGE` | 완료(A) |
