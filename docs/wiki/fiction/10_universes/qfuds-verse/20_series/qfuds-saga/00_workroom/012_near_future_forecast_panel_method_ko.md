...
패널은 세계 안 기관이 아니라 **작가실 도구**다(011 하드제약 8, 028 도메인 13·14 선례).

> **정정(2026-07-01, 사용자 지시):** 근미래 활주로는 **새 고유명·조직·인물·사건을 candidate로
> 대량 생성**해 존나 상세히 채운다(웨이브 030/031/032 방식). 단 기존 캐논 세력([015])을
> 대체·개명하지 않고 **그리로 수렴**시키며, 캐논 자동 승격은 금지하고 원고 수요 때 030 §7
