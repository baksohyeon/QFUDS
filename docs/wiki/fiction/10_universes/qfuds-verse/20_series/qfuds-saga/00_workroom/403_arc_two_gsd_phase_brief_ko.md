...
next_gate: approve arc-two episode map, then write 116 Korean primary
last_updated: 2026-07-06
---

# QFUDS SAGA 2부 GSD Phase Brief

> **번호 체계 주의(002 §10).** origin=1부 신설로 이 brief가 다루는 `who may author
> loss` 아크는 새 체계에서 **3부**에 해당한다. 제목·본문의 "2부" 표기는 origin 신설
> 이전 표기이며, 물리적 재번호·이동은 1부 origin 원고 단계에서 manuscript와 함께
> 일괄 cascade한다. 번호 SSOT는 [306 §10](../10_story_design/306_saga_arc_map_multiarc_ko.md).
...
과정으로 전개해 2부 arc를 완성한다. ep1(114)·ep2(210)은 작성·감사 완료. 이 sprint는
[2부 에피소드 맵](../10_story_design/305_arc_two_episode_map_ko.md)을 확정하고,
ep3(116)부터 한국어 정본 + 영어 counterpart를 편별로 쌓아 release 후보까지 간다.
...
- Distortion risk: 서술자가 교훈을 먼저 닫지 않도록 격언 1:1 부착 금지(210 감사 교훈).
...
- Arc 설계: [Arc Two Plan](../10_story_design/302_arc_two_korean_primary_plan_ko.md),
  [반전 설계](../10_story_design/303_last_archive_reveal_architecture_ko.md)
- bible: [인과 척추](../../../10_world/107_last_archive_origin_and_reversal_causality_ko.md),
  [세력 canon](../../../10_world/109_factions_canon_naming_ko.md),
  [Liora 시트](../00_bible/203_character_liora_sen_ko.md)
...
- Next phase: episode map 승인 → ep3(116) 한국어 정본 execute.
