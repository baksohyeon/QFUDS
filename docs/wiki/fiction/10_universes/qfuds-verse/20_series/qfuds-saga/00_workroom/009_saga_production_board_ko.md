...
| 세계 확장 웨이브 1(universe 10_world/030) | brainstorm | [10_world/030 세계 확장 웨이브 1](../../../10_world/030_world_expansion_wave1_names_places_events_ko.md) | 015/024 충돌 대조 완료(기존명 재배정 0) | 030 §7 승격 경로 | `candidate` @ universe 공유 세계 레벨; 이름=015·인물=024·세력=003·사건=026/028 웨이브별 승격 대기 |
