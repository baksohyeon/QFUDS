...
| 14도메인 세계-체계 확장(011→028) | done | [011 인계 브리프](011_expert_panel_world_system_handoff_ko.md) | canon-guardian 충돌 분류 완료(028 §1, hard-conflict 0) | 028 §4 원장 | `promoted` → [bible 028](../00_bible/028_qday_world_system_14domain_matrix_ko.md)(026 부속). 011은 provenance |
