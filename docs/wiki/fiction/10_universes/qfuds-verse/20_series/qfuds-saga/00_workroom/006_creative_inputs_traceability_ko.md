...
| --- | --- | --- |
| **원래 우주론(QFUDS) 스케치** | 연구는 `docs/02_theory`·`docs/04_results`(별개 트랙). 픽션에서는 bible [010](../../../10_world/010_last_archive_origin_and_reversal_causality_ko.md)·[011](../../../00_continuity/011_chronology_restoration_admin_black_hole_seat_ko.md) + 기획 [008](../10_story_design/008_last_archive_reveal_architecture_ko.md) | 작중 "폐기된 금지 이론 QFUDS"로 차용(증거 아님). ep5 Hawking Court 장면 |
| **세계관 스파인**(비트코인 -> 양자 -> 역연산 -> 복원, Last Archive=합의/AGI없음, 죽음의 평등) | bible [005](../../../10_world/005_bitcoin_genesis_chain_and_restoration_myth_ko.md)·[009](../../../10_world/009_reader_accessibility_and_real_world_anchors_ko.md)·[010](../../../10_world/010_last_archive_origin_and_reversal_causality_ko.md)·[011](../../../00_continuity/011_chronology_restoration_admin_black_hole_seat_ko.md)·[013](../../../10_world/013_cryptographic_death_era_and_crypto_concepts_ko.md) | 전 에피소드 세계 규칙. ep1 비트코인 설명, ep5 블랙홀, 반전축 |
| **암호학 공부 노트**(작가 연구 자산) | bible [007](../../../10_world/007_cryptographic_death_and_hash_covenant_ko.md)·[013](../../../10_world/013_cryptographic_death_era_and_crypto_concepts_ko.md) | 암호학적 죽음, 키/서명/해시 설정, identity flood |
...
| **차용 IP 경계**(Portal/아이언맨 아크/NRx/그리스신화) | bible [010](../../../10_world/010_last_archive_origin_and_reversal_causality_ko.md) Influence Boundary, [013](../../../10_world/013_cryptographic_death_era_and_crypto_concepts_ko.md) PART C | 구조만 차용, 고유명 복제 금지 |
...
| **물리·암호·Bitcoin 용어 직접 사용**(장황한 비유보다 정확한 개념 설명) | bible [009](../../../10_world/009_reader_accessibility_and_real_world_anchors_ko.md)·[017](../../../10_world/017_bitcoin_stature_ideology_deeptime_ko.md), workflow technical grounding rule | `hash`, `signature`, `ECDSA`, `SHA-256`, `Shor`, `unitarity`, `Page curve`, `island`, `entropy`, `QFUDS`를 비유로 숨기지 않고 장면 안에서 풀어쓴다 |
| **단편집이 아니라 SAGA**(해리포터·듄처럼 과몰입 가능한 연속 장편) | bible [018](../../../10_world/018_world_compendium_codex_ko.md), origin outline [016](../10_story_design/016_first_arc_origin_outline_ko.md), origin scene cards [017](../10_story_design/017_first_arc_origin_scene_cards_ko.md), active origin manuscript [030](../20_drafts/1.5부/030_origin_arc_sael_korean_primary.md), Mara reboot asset [029](../20_drafts/2부/029_first_arc_book1_reboot_korean_primary.md) | prose patching은 중단. 사엘 origin은 030으로 진행(2026-06-30에 1부→1.5부 강등; 새 1부는 「오르페우스」 035), 029는 011 §10 기준 2부 Mara 자산으로 보존 |
| **Bitcoin을 가볍게 넘기지 말 것**(사토시·국가 패권·투자자산성·0원 가능성·이념전쟁) | bible [017](../../../10_world/017_bitcoin_stature_ideology_deeptime_ko.md), [009](../../../10_world/009_reader_accessibility_and_real_world_anchors_ko.md), [005](../../../10_world/005_bitcoin_genesis_chain_and_restoration_myth_ko.md) | Bitcoin은 고대 유물이면서도 deep-time 이념전쟁의 씨앗. 투자 조언은 금지하지만 현실 위상은 정확히 적시 |
| **It from bit(s) / Bitcoin 아이러니 층**(Wheeler `it from bit` + 비트코인 말장난) | bible [006 It From Bit(s) Layer](../../../10_world/006_post_agi_civilization_history_bilingual_protocol_ko.md), codex [018 §5](../../../10_world/018_world_compendium_codex_ko.md), [005](../../../10_world/005_bitcoin_genesis_chain_and_restoration_myth_ko.md) | 현실=정보·관측 철학을 먼 미래 학자·법정의 건조한 아이러니로. 철학 motif로만, 물리 증명으로 쓰지 않음(복원=사본 전제와 일관) |
| **복원=사본 전제**(열역학 불가역, 정보 역산+인공 신체, 물리복원=금지 주장) | bible [021](../../../10_world/021_restoration_mechanism_correction_ko.md), [010 §3](../../../10_world/010_last_archive_origin_and_reversal_causality_ko.md), [009 §2.5](../../../10_world/009_reader_accessibility_and_real_world_anchors_ko.md) | 복원체는 원본 아닌 사본 → 동일성·동의·죽음의 평등이 더 날카로워짐. 029 전 장 적용 |
