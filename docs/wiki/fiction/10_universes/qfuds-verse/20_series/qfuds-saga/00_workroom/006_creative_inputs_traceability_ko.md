...
| --- | --- | --- |
| **원래 우주론(QFUDS) 스케치** | 연구는 `docs/02_theory`·`docs/04_results`(별개 트랙). 픽션에서는 bible [010](../00_bible/010_last_archive_origin_and_reversal_causality_ko.md)·[011](../00_bible/011_chronology_restoration_admin_black_hole_seat_ko.md) + 기획 [008](../10_story_design/008_last_archive_reveal_architecture_ko.md) | 작중 "폐기된 금지 이론 QFUDS"로 차용(증거 아님). ep5 Hawking Court 장면 |
| **세계관 스파인**(비트코인 -> 양자 -> 역연산 -> 복원, Last Archive=합의/AGI없음, 죽음의 평등) | bible [005](../00_bible/005_bitcoin_genesis_chain_and_restoration_myth_ko.md)·[009](../00_bible/009_reader_accessibility_and_real_world_anchors_ko.md)·[010](../00_bible/010_last_archive_origin_and_reversal_causality_ko.md)·[011](../00_bible/011_chronology_restoration_admin_black_hole_seat_ko.md)·[013](../00_bible/013_cryptographic_death_era_and_crypto_concepts_ko.md) | 전 에피소드 세계 규칙. ep1 비트코인 설명, ep5 블랙홀, 반전축 |
| **암호학 공부 노트**(작가 연구 자산) | bible [007](../00_bible/007_cryptographic_death_and_hash_covenant_ko.md)·[013](../00_bible/013_cryptographic_death_era_and_crypto_concepts_ko.md) | 암호학적 죽음, 키/서명/해시 설정, identity flood |
...
| **단편집이 아니라 SAGA**(해리포터·듄처럼 과몰입 가능한 연속 장편) | bible [018](../00_bible/018_world_compendium_codex_ko.md), origin outline [016](../10_story_design/016_first_arc_origin_outline_ko.md), origin scene cards [017](../10_story_design/017_first_arc_origin_scene_cards_ko.md), active origin manuscript [030](../20_drafts/1부/030_origin_arc_sael_korean_primary.md), Mara reboot asset [029](../20_drafts/2부/029_first_arc_book1_reboot_korean_primary.md) | prose patching은 중단. 신규 1부는 030 origin으로 진행하고, 029는 011 §10 기준 2부 Mara 자산으로 보존 |
...
| **실제 프로즈** | `20_drafts`(cascade 완료: [1부/030](../20_drafts/1부/030_origin_arc_sael_korean_primary.md) 1부 origin, [2부/029](../20_drafts/2부/029_first_arc_book1_reboot_korean_primary.md) 2부 Mara, [3부/](../20_drafts/3부/README.md) 3부 author-loss 025-027) | 번호 SSOT는 011 §10. 원고 번호·`arc_two` doc_id는 stable ID로 보존하고, physical cascade는 2026-06-21 완료 |
