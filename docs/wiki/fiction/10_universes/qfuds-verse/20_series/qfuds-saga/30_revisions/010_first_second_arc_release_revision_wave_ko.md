...
| --- | --- | --- |
| `20_drafts/1부/030_origin_arc_sael_korean_primary.md` | `polish` + `continuity` | B1 stakes 정렬 유지, B3~B7의 경구형 문장과 추상 명제 일부를 손/화면/로그 중심으로 낮춤 |
...
| `00_workroom/009_saga_production_board_ko.md` | `chronicler` | active revision wave와 잔여 release risk만 기록 |
