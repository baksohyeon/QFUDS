---
doc_id: qfuds_saga_pre_reboot_first_arc_release_manifest_ko
title: QFUDS SAGA Pre-Reboot 1부 Release Manifest
doc_type: index
stage: reference
status: provenance
...
## Pre-Reboot Prototype Reading Order
...
이 manifest는 당시 통과한 pre-reboot 감사를 보존한다. 이후 추가된
