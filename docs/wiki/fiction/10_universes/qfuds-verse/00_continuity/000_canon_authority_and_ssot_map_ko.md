...
흩어져 있었다(명칭은 015, 복원은 021, 인과는 010/011…). 신규 작업자가 현행 기준을
...
주의: 이건 **제작 거버넌스**다. 작중 주제인 "진짜 SSOT는 없다"(022 §1, 합의의
신격화)와는 다른 층위다. 작품은 SSOT 부재를 그리되, 제작은 master 권위 지도를 둔다.
[018 컴펜디움](../10_world/018_world_compendium_codex_ko.md)은 **색인/내비게이션**이고, 이 000은
**권위/충돌 해소**다.
...
| 도메인 | 최종 권위 | 비고 |
| --- | --- | --- |
| 복원 메커니즘(사본/열역학/역연산 금지) | [021](../10_world/021_restoration_mechanism_correction_ko.md) | 005·002의 "완전복원/역연산"은 작중 금지·논쟁 이론으로 강등 |
...
| 주제축(기준 작성권) | [022](../20_series/qfuds-saga/00_bible/022_authorship_of_the_standard_theme_axis_ko.md) | |
| 독자 접근성·실세계 검증 닻 | [009](../10_world/009_reader_accessibility_and_real_world_anchors_ko.md) | 기술·역사 정확성 대장 |
| 인물 | [012](../20_series/qfuds-saga/00_bible/012_character_liora_sen_ko.md)(Liora) · [016](../20_series/qfuds-saga/00_bible/016_character_ensemble_voices_relationships_ko.md)(앙상블 보이스·관계) · [019](../20_series/qfuds-saga/00_bible/019_character_depth_sheets_ko.md)(입체 시트) | 016↔019 중복 정리 검토 대상 |
| 반전 노출 스케줄 | [story_design/008](../20_series/qfuds-saga/10_story_design/008_last_archive_reveal_architecture_ko.md) | "무엇이 진짜"는 010, "언제 드러내나"는 008 |
| 이중언어 용어규율 | [workroom/003](../20_series/qfuds-saga/00_workroom/003_bilingual_term_discipline_glossary_ko.md) | |

## 전역 충돌 해소 규칙

1. **명시적 우선 선언이 최우선.** 어떤 문서가 "이 도메인은 내가 우선"이라 명시하면
   그것을 따른다(예: 021 §우선, 015 §명칭 충돌 해소).
2. 다음으로 **위 도메인 권위 표**를 따른다.
3. 그래도 갈리면 **last_updated가 더 최근인 문서**가 이긴다.
4. 그래도 불명확하면 **unknown으로 표시하고 작가 판정에 올린다**(빈 도장 윤리, 020).
