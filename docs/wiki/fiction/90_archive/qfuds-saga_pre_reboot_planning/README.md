---
doc_id: qfuds_saga_pre_reboot_planning_archive_index
title: QFUDS SAGA reboot 이전 기획 아카이브
doc_type: index
stage: reference
status: provenance
...
`qfuds-verse` / `qfuds-saga`의 **outline-first reboot 이전 세대 기획·퇴고 문서**를
보관한다. active 트랙이 아니며 fiction/provenance only, QFUDS 연구 증거 아님.
