...
## Korean-Primary Bilingual Drafting

SAGA의 active prose 기본 순서는 이제 한국어 우선이다.

```text
한국어 본문 초안 -> 영어권 독자용 독립 각색판 -> 공유 continuity 점검
```

한국어판은 독자가 먼저 읽는 본문이다. 직역투가 아니라 한국어 소설 문장으로
쓴다. 영어판은 같은 사건, 같은 field mark, 같은 인물 선택을 공유하지만 영미권
리듬과 관용, 장르 기대에 맞춘 독립 각색판으로 쓴다.

기존 English-first draft는 provenance와 source counterpart로 보존한다. 이후 새
episode나 revision은 사용자가 다르게 지시하지 않는 한 한국어 본문을 먼저 쓰고,
그 다음 영어판을 붙인다.
