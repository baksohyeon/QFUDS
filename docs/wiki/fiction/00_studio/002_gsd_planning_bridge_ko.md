...
이 문서의 내용은
[003 Fiction GSD 하네스 운영 가이드](003_fiction_gsd_harness_operator_guide_ko.md)로
통합됐다. GSD가 맡는 것/맡지 않는 것, phase 문서 필수 항목, 추천 사용 순서는
003에 있다.
...
- 통합 가이드:
  [003 Fiction GSD 하네스 운영 가이드](003_fiction_gsd_harness_operator_guide_ko.md).
