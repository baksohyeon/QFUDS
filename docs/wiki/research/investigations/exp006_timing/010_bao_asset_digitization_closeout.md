...
| --- | --- | --- |
| [DESI DR2 data-release parse](../../assets/desi_dr2_lya_bao_2025/digitization/desi_dr2_lya_bao_data_release.md) | `source_text_parse` | Markdown inspection record for the cached Zenodo archive |
...
| [eBOSS DR16 likelihood-release parse](../../assets/eboss_dr16_lya_bao_2020/digitization/eboss_dr16_lya_bao_likelihood_release.md) | `source_text_parse` | Markdown inspection record for the cached SDSS likelihood grids |
...
MarkItDown 0.1.6 was installed and used to convert the cached upstream README
files. The curated Markdown products were assembled from cached source README,
