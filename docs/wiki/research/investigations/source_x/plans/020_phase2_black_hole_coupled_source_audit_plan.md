...
- [docs/wiki/research/investigations/source_x/conclusions/011_phase1_source_x_audit.md](../conclusions/011_phase1_source_x_audit.md)
...
- missing physics map remains the source of truth for missing admission-rule
  items;
- blocked admission rule gate defines the required five-item gate;
