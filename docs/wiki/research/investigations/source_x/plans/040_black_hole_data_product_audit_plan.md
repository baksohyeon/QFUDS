...
Any future rerun of this plan must follow the
[Research Asset and Product Workflow](../../../../../../.agent/workflows/research-asset-product-workflow.md)
before making product-availability, asset-state, extraction-completeness, or
...
If a paper exists but has no extractable data product after workflow inspection,
record the exact asset state. Do not collapse unread PDFs, unextracted source
bundles, or uncached Zenodo assets into literature-only or no-product claims.

If data exists but lacks units, uncertainty, redshift coverage, or a
normalization route, record it as product hit / not QFUDS-usable.
...
For every search axis, include a hit/state/cache table with these columns:
...
- Data-product investigation results go under
  [Source-X Research Investigations](../README.md).
- Raw, extracted, figure, or digitization assets follow the research-chain
  structure under
  `docs/wiki/research/assets/<paper_or_release_key>/source/`,
  `docs/wiki/research/assets/<paper_or_release_key>/figures/`, and
...
- records QFUDS-ready products not found as dated, scope-limited findings only
  after asset-state inspection.
...
- a dated statement of QFUDS-ready products not found;
