...
| `outputs/figures/result000_lcdm_baseline.png` | visualizes the LCDM-control invariants and the phase bookkeeping split | [docs/04_results/000_result_000_lcdm_baseline.md](../04_results/000_result_000_lcdm_baseline.md), [docs/00_project/decision_log.md](decision_log.md) |
...
| `outputs/figures/result001_gamma_scan_summary.png` | visualizes timing-shape differences and the background-screening pressures for experiment 001 | [docs/04_results/010_result_001_gamma_scan.md](../04_results/010_result_001_gamma_scan.md), [docs/00_project/decision_log.md](decision_log.md) |
...
| `outputs/figures/result002_entropy_information_summary.png` | visualizes why broad entropy timing failed while information production survived only as a proxy shape | [docs/04_results/020_result_002_entropy_information_gate.md](../04_results/020_result_002_entropy_information_gate.md), [docs/00_project/decision_log.md](decision_log.md) |
| `outputs/figures/result001_5_physicality_audit.png` | visualizes the missing ingredients behind the Level 1.5 physical-promotion failure | [docs/04_results/015_result_001_5_phase_transfer_physicality.md](../04_results/015_result_001_5_phase_transfer_physicality.md), [docs/00_project/decision_log.md](decision_log.md) |
...
| `outputs/figures/exp003_stability_summary.png` | visualizes the P1/P2 stability split and the predeclared instability threshold | [docs/04_results/030_result_003_phenomenological_perturbation_closure.md](../04_results/030_result_003_phenomenological_perturbation_closure.md), [docs/00_project/decision_log.md](decision_log.md) |
...
| `outputs/exp004_positioning_summary.json` | retained P1 is an exact interacting-vacuum instance and a subset of time-dependent IDE under `xi(a)=Gamma(a)` | [docs/04_results/030_result_004_p1_model_family_positioning.md](../04_results/030_result_004_p1_model_family_positioning.md), [docs/00_project/decision_log.md](decision_log.md) |
| `outputs/exp004_baseline_comparison.csv` | simple constant and power-law transfer baselines differ from retained P1 by transfer-shape parameterization rather than physical source derivation | [docs/04_results/030_result_004_p1_model_family_positioning.md](../04_results/030_result_004_p1_model_family_positioning.md), [docs/00_project/decision_log.md](decision_log.md) |
| `outputs/figures/exp004_gamma_shape_comparison.png` | visualizes why simple constant and power-law transfer bases do not reproduce retained timing | [docs/04_results/030_result_004_p1_model_family_positioning.md](../04_results/030_result_004_p1_model_family_positioning.md), [docs/00_project/decision_log.md](decision_log.md) |
| `outputs/exp005_timing_prior_summary.json` | retained timing is potentially useful as a compression target for IV/IDE timing histories, not as a physical source | [docs/04_results/030_result_005_timing_prior_usefulness.md](../04_results/030_result_005_timing_prior_usefulness.md), [docs/00_project/decision_log.md](decision_log.md) |
| `outputs/exp005_timing_family_comparison.csv` | rigid constant and power-law families are too rigid; flexible reconstruction matches retained timing better than compact pulse families | [docs/04_results/030_result_005_timing_prior_usefulness.md](../04_results/030_result_005_timing_prior_usefulness.md), [docs/00_project/decision_log.md](decision_log.md) |
| `outputs/figures/exp005_timing_family_errors.png` | visualizes the timing-prior decision threshold and why retained timing remains a compression target | [docs/04_results/030_result_005_timing_prior_usefulness.md](../04_results/030_result_005_timing_prior_usefulness.md), [docs/00_project/decision_log.md](decision_log.md) |
