...
QFUDS는 확정 이론이 아니라 초기 단계의 우주론 연구 프로그램입니다. 질문은 간단하지만
검증은 어렵습니다. 암흑물질과 암흑에너지가 같은 양자 시공간 거품 부문의 서로 다른
거시적 모습일 수 있을까?

이 저장소에서 가장 중요한 산출물은 **에이전틱 연구 하네스**입니다. 워크플로, 캐시,
파서 라우팅, 적대적 검토, 게이트를 묶어 추측성 탐색을 감사 가능한 작업으로 만든
시스템입니다. 첫 입구는
[lineage 006](../wiki/lineage/006_agentic_research_system_ko.md)입니다. 물리 문서들은
그 하네스로 읽고, 밀어붙이고, 검토한 대상입니다. 근거가 부족하면 강등했습니다.

이 저장소의 목적은 QFUDS를 옹호하는 것이 아닙니다. 아이디어를 검증하고, 비교하고,
좁히고, 필요하면 폐기할 수 있을 만큼 분명하게 만드는 데 목적이 있습니다. 현재 프로젝트
상태는 [로드맵](../05_next_steps/000_roadmap.md)만 말할 수 있습니다.

외부 논문, PDF, 데이터 제품, NASA/BAO/DESI 같은 자료 언급은
[Research Asset and Product Workflow](../../.agent/workflows/research-asset-product-workflow.md)의
경계를 따릅니다. 이 개요는 새 외부 claim을 만들지 않고 기존 연구 기록만 요약합니다.
기존 source-state token은 `asset_cached`, `asset_extracted_not_digitized`,
`source_text_parse`, `manual_structured_extract`, `inspected_no_numerical_product`입니다.
...
- [lineage 007](../wiki/lineage/007_black_hole_information_public_bridge_ko.md)은
  블랙홀 정보 문제에서 시작한 출발 서사를 provenance로 보존합니다. 물리 증거는 아닙니다.
- [lineage 008](../wiki/lineage/008_gamma_to_academic_iv_bridge_result_ko.md)은
  유지된 `Gamma(a)`가 학계 IV/IDE 언어로 어디까지 번역되고 어디서 멈추는지 정리합니다.
  물리 유도는 아닙니다.
- [lineage 009](../wiki/lineage/009_qfuds_public_story_bridge_ko.md)는
  초등학생도 읽을 수 있게 블랙홀, 진공 에너지, `Gamma(a)`, 우주 거품 상상을 하나의
  이야기로 풀어 주는 public story bridge입니다. 물리 증거는 아닙니다.
- [fiction/](../../fiction/README.md)(+[creative_harness/](../../creative_harness/README.md))은
  별도 취미 트랙입니다. 핵심은 소설 결과물이 아니라, 픽션 작가를 위한
  에이전틱 하네스입니다. 세계관을 IP처럼 관리하고, 연속성, 검토, 초안 관리
  워크플로를 실험합니다. 물리 증거도 연구 결과도 아닙니다.
...
| 선택 보관본. 첫 독해용 아님 | [lineage 005](../wiki/lineage/005_rough_tanh_thesis_report_ko.md) |
| 블랙홀 정보 출발 서사 | [lineage 007](../wiki/lineage/007_black_hole_information_public_bridge_ko.md) |
| Gamma가 멈춘 지점 | [lineage 008](../wiki/lineage/008_gamma_to_academic_iv_bridge_result_ko.md) |
| 가장 쉬운 이야기 입구 | [lineage 009](../wiki/lineage/009_qfuds_public_story_bridge_ko.md) |
| 픽션 작가용 취미 하네스 | [fiction/](../../fiction/README.md) 및 [creative_harness/](../../creative_harness/README.md) |
| 유지된 `Gamma(a)`의 IV/IDE 번역 경로 | [Academic Derivation Bridge](../wiki/research/investigations/source_x/conclusions/055_academic_derivation_bridge_ko.md) |
...
논문 형식으로 압축해 둔 보관본입니다. 유용하지만 첫 독해용은 아닙니다. 실제 입구는
003과 004입니다.

## 실제로 남은 것

이 저장소가 보여주는 가장 강한 결과는 QFUDS가 확정 이론이 됐다는 것이 아닙니다.
그렇지 않습니다. 의미 있는 결과는 더 작고 분명합니다. 넓은 직관을 명시적 테스트로
밀어 넣었고, 무엇이 살아남았는지, 무엇이 기존 IV/IDE 언어로 환원됐는지, 어디서 현대
우주론의 미해결 난제에 막혔는지를 파일로 남겼습니다.

그래서 읽는 순서는 단순합니다. 먼저 에이전틱 연구 하네스를 보고, 검증된 본 줄기인
003, 그다음 거칠게 끝까지 밀어본 004를 보면 됩니다. 005는 입문 문서라기보다 논문형
보관본입니다. fiction 영역은 별도 취미 트랙입니다. 픽션 작가용 에이전틱 워크플로와
IP식 세계관 관리 실험이지, 연구 결과가 아닙니다.

## 이 저장소 읽는 법: 하네스 먼저, 그다음 두 연구 단계

이 프로젝트에는 성격이 다른 세 층이 있습니다. 어느 층을 읽고 있는지에 따라 문장의
무게가 달라집니다. 각 층은 맡은 일이 다르고, 증거로서의 무게도 다릅니다.
...
재사용 가능한 것이 무엇인지 보려면 이 층부터 읽으면 됩니다.
...
한 줄로: **lineage 006은 재사용 가능한 하네스이고, 1단계는 003까지의 검증된 본 줄기,
2단계는 실패한 구현체를 그래도 벽까지 밀어붙였을 때 나온 기록입니다. 대표 기록은 004이고,
005는 선택적으로 읽는 논문형 보관본입니다.**

## 핵심 산출물: 에이전틱 연구 하네스

물리 이야기는 payload에 가깝습니다. 핵심 산출물은 그 결과를 만들고 걸러낸 작업
시스템입니다. 핵심은 일관된 피드백 루프였습니다. AI가 맞는다고 믿은 것이 아니라,
...
- **요약본이 아니라 진짜 논문을 읽습니다.** [PageIndex](https://github.com/VectifyAI/PageIndex)와 [MarkItDown](https://github.com/microsoft/markitdown)을 MCP로 붙였습니다.
  MCP는 AI 에이전트에 외부 도구를 연결하는 표준 방식입니다. 여기서 중요한 건 단순한
  PDF -> Markdown 변환이 아니라 파서 라우팅이었습니다. 논문 PDF와 arXiv source는
  [PageIndex](https://github.com/VectifyAI/PageIndex)로 구조·페이지·본문을 뽑고, 데이터 릴리스나 매니페스트·표·코드는
  [MarkItDown](https://github.com/microsoft/markitdown)으로 처리했습니다. 그림은 따로 추출했고, Chen Figure 5의 색상별 곡선은
...
비유하면, 물은 조건에 따라 얼음, 액체 물, 수증기로 보일 수 있습니다. QFUDS도 암흑부문에 비슷한 질문을 던집니다. 하나의 바탕 매질이 어떤 조건에서는 물질처럼 보이고, 다른 조건에서는 진공압처럼 보일 수 있는가?
...
최신 front-door 결론은 [lineage 008](../wiki/lineage/008_gamma_to_academic_iv_bridge_result_ko.md)과
[Gamma IV Bridge Branch Closeout](../wiki/research/investigations/source_x/conclusions/059_gamma_iv_bridge_branch_closeout_ko.md)에
정리돼 있습니다. 유지된 `Gamma(a)`는 IV/IDE를 읽기 위한 timing comparator와 학습
손잡이로는 쓸 수 있지만, `Q^mu`, phase-B pressure, perturbations, novelty를 유도하지
못했습니다. 그래서 이 bridge는 learning/audit harness로 닫혔고, 물리 QFUDS로는 닫히지
않았습니다.
...
가장 크게 남은 것은 "이런 식으로도 배울 수 있구나"라는 깨달음이었습니다. 남은 것은
다섯 가지입니다.
...
- [006_agentic_research_system_ko.md](../wiki/lineage/006_agentic_research_system_ko.md): 핵심 에이전틱 연구 하네스 기록. 문서·상태 경계, 워크플로 라우팅, 자산 캐시 상태 사다리, [PageIndex](https://github.com/VectifyAI/PageIndex)/[MarkItDown](https://github.com/microsoft/markitdown) MCP, 적대적 검토 패스, 결정론적 깃훅 게이트, 회고 피드백 루프
...
- [007_black_hole_information_public_bridge_ko.md](../wiki/lineage/007_black_hole_information_public_bridge_ko.md): 블랙홀 정보 문제에서 시작한 출발 서사를 public bridge로 보존. 물리 증거는 아님
- [008_gamma_to_academic_iv_bridge_result_ko.md](../wiki/lineage/008_gamma_to_academic_iv_bridge_result_ko.md): 유지된 `Gamma(a)`가 IV/IDE formalism으로 어디까지 번역되고 어디서 멈추는지 정리
- [009_qfuds_public_story_bridge_ko.md](../wiki/lineage/009_qfuds_public_story_bridge_ko.md): 초등학생도 읽을 수 있는 가장 쉬운 이야기 입구. 동기 보존용이며 물리 증거는 아님
- [fiction/](../../fiction/README.md)(+[creative_harness/](../../creative_harness/README.md)): 별도 취미 트랙. 소설 결과물보다 픽션 작가용 에이전틱 하네스, IP식 세계관 관리, 연속성 라우팅, 검토 워크플로, 초안 관리 실험이 핵심
