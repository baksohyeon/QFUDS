...
[lineage/assets/](../wiki/lineage/assets/)에 모았고, 그걸 현상론적으로 정리한 글이
[lineage 004](../wiki/lineage/004_rough_tanh_numerical_sketch_ko.md)와
[lineage 005](../wiki/lineage/005_rough_tanh_thesis_report_ko.md)입니다. 바로 아래
...
벽까지 밀어붙였을 때 나온 것(004에서 005)입니다.**

## 현재 위치: 벽까지 밀어붙여 실제로 알아낸 것

*2단계: 거칠게 밀어붙인 부분. 통과 기준을 건 실험이 아니라 현상론적 스케치(lineage
004에서 005)입니다.*
...
- **긍정 주장은 따로 깨 봅니다.** "줄였다", "유도했다", "통과했다" 같은 결론을 쓸 때마다
  ...
  [lineage 005](../wiki/lineage/005_rough_tanh_thesis_report_ko.md)).
