...
경계를 따릅니다. 이 개요는 새 외부 claim을 만들지 않고 기존 연구 기록을 요약합니다.
상속된 source-state token은 `asset_cached`, `asset_extracted_not_digitized`,
...
- [lineage 010](../wiki/lineage/010_qfuds_closing_sf_story_ko.md)은
  원본 단편을 보존하고 확장 단편 "암호문을 삼킨 우주"를 덧붙여 QFUDS 여정을 닫는
  fiction companion입니다. 연구 결과나 물리 증거는 아닙니다.
- [QFUDS Fiction Saga Archive](../wiki/fiction/90_archive/lineage-prototype/README.md)는
  라우어 관측소, 감사관, Gamma 신호를 중심으로 한 초기 SF 연재 prototype입니다.
  현재 active SAGA는 [QFUDS SAGA](../wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/README.md)에서
  관리합니다. 둘 다 물리 증거는 아닙니다.
...
| 마무리용 SF 단편 | [lineage 010: 방정식은 입장권이다 / 암호문을 삼킨 우주](../wiki/lineage/010_qfuds_closing_sf_story_ko.md) |
| SF 연재 세계관 | [QFUDS SAGA](../wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/README.md) |
...
- [010_qfuds_closing_sf_story_ko.md](../wiki/lineage/010_qfuds_closing_sf_story_ko.md): 원본 단편을 보존하고 확장 단편 "암호문을 삼킨 우주"를 덧붙인 fiction companion. 동기 보존용이며 물리 증거는 아님
- [QFUDS Fiction Saga Archive](../wiki/fiction/90_archive/lineage-prototype/README.md): 인물,
  관계, 시즌 arc, 에피소드를 갖춘 초기 SF 연재 prototype. 동기 보존용이며 물리 증거는 아님
- [QFUDS SAGA](../wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/README.md):
  현재 active fiction-system track. planning, canon, drafts를 관리하며 물리 증거는 아님
