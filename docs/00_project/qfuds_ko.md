...
- [docs/wiki/fiction/](../wiki/fiction/)은 별도 취미 트랙입니다. 핵심은 소설 결과물이
  아니라, 픽션 작가를 위한 에이전틱 하네스입니다. 세계관을 IP처럼 관리하고,
  연속성, 검토, 초안 관리 워크플로를 실험합니다. 물리 증거도 연구 결과도 아닙니다.
...
| 픽션 작가용 취미 하네스 | [docs/wiki/fiction/](../wiki/fiction/) |
...
- [docs/wiki/fiction/](../wiki/fiction/): 별도 취미 트랙. 소설 결과물보다 픽션 작가용 에이전틱 하네스, IP식 세계관 관리, 연속성 라우팅, 검토 워크플로, 초안 관리 실험이 핵심
