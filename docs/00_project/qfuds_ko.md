...
전성기, Cosmic Noon(우주 전성기)입니다. 더 골때리는 건 기존 학계도 여기서 멈춘다는
것입니다. "feature는 보인다. 근데 왜인지는 모른다." 표준 ΛCDM은 암흑물질↔암흑에너지
...
정직한 결론은 이렇습니다. 내 답은 아직 없습니다. Gamma(a)는 전체 가설이 아니라 첫
프로토타입 구현체였고, 그 프로토타입이 졌을 뿐입니다. 살아남은 핵심은 "구조 형성
시기와 암흑부문 상호작용 타이밍이 관련 있을 수 있다"는 부분입니다. 그리고 내가
궁금해한 게 실제로도 아무도 깔끔하게 모르는 질문이었다는 점이 제일 골때립니다. 상태
