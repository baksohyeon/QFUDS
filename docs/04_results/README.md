...
- [015_result_001_5_phase_transfer_physicality.md](015_result_001_5_phase_transfer_physicality.md): Level 1.5 hostile result; `Gamma(a)` is still phenomenological, not derived physics.
- [020_result_002_entropy_information_gate.md](020_result_002_entropy_information_gate.md): experiment 002 provenance scan; collapse/information production is retained only as a Level 1.5 audit question.
