...
- [015_result_001_5_phase_transfer_physicality.md](015_result_001_5_phase_transfer_physicality.md): [Level 1.5](../wiki/glossary/repository_levels.md) hostile result; retained `Gamma(a)` branch failed physical promotion and is demoted to phenomenological interacting vacuum.
