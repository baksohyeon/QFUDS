...
Theory and literature-positioning documents.

This folder is not the experiment record. It defines hypotheses, assumptions, equations, and model versions.

Use these folders for validation evidence:

- `docs/03_experiments/`: experiment definitions and reproducible commands.
- `docs/04_results/`: result reports, analysis reports, figures, and decisions.
- `outputs/`: generated CSV and PNG artifacts from the numerical runs.
...
- [015_qfuds_strong_gravity_source_mechanism_audit.md](015_qfuds_strong_gravity_source_mechanism_audit.md): strong-gravity source-mechanism audit for the broader DM-to-DE phase-transition hypothesis.
- [030_qfuds_phenomenological_perturbations.md](030_qfuds_phenomenological_perturbations.md): Level 2A audit note for perturbation closure while `Gamma(a)` remains phenomenological.
- [900_qfuds_research_report.md](900_qfuds_research_report.md): adversarial literature comparison and mathematical formulation.
