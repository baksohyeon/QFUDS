...
두 번째 단계에서는 수렴했습니다. 생각이 너무 멀리 뻗은 뒤, 가장 큰 이미지를 잘라내고 끝까지 남는 질문을 골랐습니다.
...
세 번째 단계에서 검증 압력이 생겼습니다. 제가 이것을 dark-sector toy model로 쓰는 순간, 더는 은유나 느낌만으로 버틸 수 없었습니다. 평범한 우주론 관측 앞에 세워야 했습니다.
