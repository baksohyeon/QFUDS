...
- [Source Object X Definition Preflight Plan](wiki/research/investigations/source_x/plans/059_source_object_x_definition_preflight_plan_ko.md) - freezes the minimum source-object fields before retained timing or observational comparison
...
- [Escamilla 2023 IV/IDE Kernel Equation Extraction Result](wiki/research/investigations/source_x/conclusions/059_escamilla_2023_iv_ide_kernel_equation_extraction_result_ko.md) - Escamilla 2023 background-kernel extraction for `Pi_DE`, `I_Q`, sign convention, and background-only stop
- [Li/Escamilla IV/IDE Convention Comparison Note](wiki/research/investigations/source_x/conclusions/059_li_escamilla_iv_ide_convention_comparison_note_ko.md) - compares Li and Escamilla convention hazards before timing fit or baseline-constraint use
- [Martinelli 2019 IV/Geodesic-CDM Equation Extraction Result](wiki/research/investigations/source_x/conclusions/059_martinelli_2019_iv_geodesic_cdm_equation_extraction_result_ko.md) - Martinelli 2019 extraction for `Q`, `Q_mu`, CDM-frame perturbation closure, and CAMB route
- [Hogg 2020 IV/Geodesic-CDM Equation Extraction Result](wiki/research/investigations/source_x/conclusions/059_hogg_2020_iv_geodesic_cdm_equation_extraction_result_ko.md) - Hogg 2020 extraction for `Q`, `Q_mu`/frame summary, 17-bin CPZ-prior reconstruction, PCA, and evidence boundary
- [Martinelli/Hogg IV/Geodesic-CDM Same-Family Comparison Note](wiki/research/investigations/source_x/conclusions/059_martinelli_hogg_iv_geodesic_cdm_same_family_comparison_note_ko.md) - separates shared geodesic-CDM formalism from reconstruction guardrails
- [Wang 2015 IV Equation Extraction Result](wiki/research/investigations/source_x/conclusions/059_wang_2015_iv_equation_extraction_result_ko.md) - Wang 2015 extraction for historical `alpha(a)`, nonlinear density-factor `Q`, DM-frame closure, perturbation/RSD route, PCA, and evidence boundary
- [Wang/Martinelli/Hogg IV Convention Comparison Note](wiki/research/investigations/source_x/conclusions/059_wang_martinelli_hogg_iv_convention_comparison_note_ko.md) - compares Tier 1 IV sign, density-factor, frame, perturbation, RSD, prior/PCA, and evidence boundaries
- [Tier 1 IV Extraction Pass Closeout](wiki/research/investigations/source_x/conclusions/059_tier1_iv_extraction_pass_closeout_ko.md) - closes Tier 1 IV extraction and freezes retained `Gamma(a)` as comparator-only formalism bridge
- [Retained Gamma IV Non-Equivalence Worksheet](wiki/research/investigations/source_x/conclusions/059_retained_gamma_iv_non_equivalence_worksheet_ko.md) - marks retained `Gamma(a)` to Martinelli/Hogg `q_V(a)` conversions as defined, assumed, unknown, or circular-if-fitted
- [Source Object X Definition Audit Result](wiki/research/investigations/source_x/conclusions/059_source_object_x_definition_audit_result_ko.md) - executes the `X` definition audit and admits no current candidate as a physical QFUDS source object
- [Gamma IV Bridge Branch Closeout](wiki/research/investigations/source_x/conclusions/059_gamma_iv_bridge_branch_closeout_ko.md) - closes the retained `Gamma(a)` to IV/IDE bridge as learning/audit harness, not physical QFUDS
