---
doc_id: zkqv_2fa772ecd166
title: ZK Queue - 3. Domain Ownership Map (선반별 소유)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - 3. Domain Ownership Map (선반별 소유)
...
- Source line: [line 190](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/00_continuity/900_worldbuilding_architecture_ko.md)
- Heading level: `H2`
- Source heading: `3. Domain Ownership Map (선반별 소유)`
