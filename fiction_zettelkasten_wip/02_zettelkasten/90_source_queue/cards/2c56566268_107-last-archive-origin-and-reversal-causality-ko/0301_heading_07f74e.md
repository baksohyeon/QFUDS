---
doc_id: zkqv_07f74eba2eac
title: ZK Queue - 8. 데뷔 — 인류가 Last Archive를 처음 직면하는 장면
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - 8. 데뷔 — 인류가 Last Archive를 처음 직면하는 장면
...
- Source line: [line 301](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/107_last_archive_origin_and_reversal_causality_ko.md)
- Heading level: `H2`
- Source heading: `8. 데뷔 — 인류가 Last Archive를 처음 직면하는 장면`
