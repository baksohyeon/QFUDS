---
doc_id: zkqv_cfdca2855b6c
title: ZK Queue - QFUDS Verse 제텔카스텐 아이디어 인박스
doc_type: reference
stage: reference
status: draft
evidence_role: provenance
depends_on:
  - qfuds_verse_zettelkasten_inbox_ko
next_gate: process this queue card into an atomic permanent zettel or mark it as source-only
last_updated: 2026-07-07
---

# ZK Queue - QFUDS Verse 제텔카스텐 아이디어 인박스
...
- Source line: [line 14](../../../../../../../docs/wiki/fiction/01_catalog/006_zettelkasten_inbox_ko.md)
- Heading level: `H1`
- Source heading: `QFUDS Verse 제텔카스텐 아이디어 인박스`
