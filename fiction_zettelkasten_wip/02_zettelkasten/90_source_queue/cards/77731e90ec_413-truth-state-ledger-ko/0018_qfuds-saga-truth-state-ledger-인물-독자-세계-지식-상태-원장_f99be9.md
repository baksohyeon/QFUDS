---
doc_id: srcidx_f99be9f2ae011169
title: "Source Index - QFUDS SAGA Truth-State Ledger (인물·독자·세계 지식 상태 원장)"
doc_type: reference
stage: reference
status: draft
...
# Source Index - QFUDS SAGA Truth-State Ledger (인물·독자·세계 지식 상태 원장)
...
- Source line: [line 18](../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/00_workroom/413_truth_state_ledger_ko.md)
- Heading level: `H1`
- Source heading: `QFUDS SAGA Truth-State Ledger (인물·독자·세계 지식 상태 원장)`
