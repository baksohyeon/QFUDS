---
doc_id: zkqv_41c247d2b0ad
title: ZK Queue - QFUDS SAGA 비트코인 위상·이념전쟁·심층시간 유효성
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - QFUDS SAGA 비트코인 위상·이념전쟁·심층시간 유효성
...
- Source line: [line 16](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/110_bitcoin_stature_ideology_deeptime_ko.md)
- Heading level: `H1`
- Source heading: `QFUDS SAGA 비트코인 위상·이념전쟁·심층시간 유효성`
