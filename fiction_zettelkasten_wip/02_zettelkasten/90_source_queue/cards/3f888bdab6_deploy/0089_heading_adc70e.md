---
doc_id: zkqv_adc70e9b48bb
title: ZK Queue - systemd (최소 풋프린트)
doc_type: reference
stage: reference
status: draft
...
- Source line: [line 89](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/web/DEPLOY.md)
- Heading level: `H1`
- Source heading: `systemd (최소 풋프린트)`
