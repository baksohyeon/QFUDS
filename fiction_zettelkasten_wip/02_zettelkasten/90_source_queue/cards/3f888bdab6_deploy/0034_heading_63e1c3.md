---
doc_id: zkqv_63e1c316810e
title: ZK Queue - Dokku 배포 (홈서버, `git push dokku main`)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - Dokku 배포 (홈서버, `git push dokku main`)
...
- Source line: [line 34](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/web/DEPLOY.md)
- Heading level: `H2`
- Source heading: `Dokku 배포 (홈서버, `git push dokku main`)`
