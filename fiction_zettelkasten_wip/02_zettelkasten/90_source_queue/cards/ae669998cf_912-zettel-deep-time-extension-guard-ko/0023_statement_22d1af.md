...
- Source line: [line 23](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/00_continuity/912_zettel_deep_time_extension_guard_ko.md)
- Heading level: `H2`
- Source heading: `Statement`

## Parent Context

- H1: 심층시간은 확장 레이어이며 상위 가드를 넘지 않는다
