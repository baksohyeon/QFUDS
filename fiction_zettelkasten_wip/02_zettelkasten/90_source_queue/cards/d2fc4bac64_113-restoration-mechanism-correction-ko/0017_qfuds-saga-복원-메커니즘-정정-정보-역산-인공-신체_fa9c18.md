---
doc_id: srcidx_fa9c1894a5cc6f52
title: "Source Index - QFUDS SAGA 복원 메커니즘 정정 (정보 역산 + 인공 신체)"
doc_type: reference
stage: reference
status: draft
...
# Source Index - QFUDS SAGA 복원 메커니즘 정정 (정보 역산 + 인공 신체)
...
- Source line: [line 17](../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/113_restoration_mechanism_correction_ko.md)
- Heading level: `H1`
- Source heading: `QFUDS SAGA 복원 메커니즘 정정 (정보 역산 + 인공 신체)`
