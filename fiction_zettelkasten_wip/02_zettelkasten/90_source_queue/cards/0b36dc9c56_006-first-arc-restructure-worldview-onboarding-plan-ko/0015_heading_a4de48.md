---
doc_id: zkqv_a4de48aa0432
title: ZK Queue - QFUDS SAGA 1부 구조 재구성 계획 (세계관 온보딩)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - QFUDS SAGA 1부 구조 재구성 계획 (세계관 온보딩)
...
- Source line: [line 15](../../../../../../../docs/wiki/fiction/90_archive/qfuds-saga_pre_reboot_planning/30_revisions/006_first_arc_restructure_worldview_onboarding_plan_ko.md)
- Heading level: `H1`
- Source heading: `QFUDS SAGA 1부 구조 재구성 계획 (세계관 온보딩)`
