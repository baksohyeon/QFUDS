---
doc_id: zkqv_dd41bc607d1f
title: ZK Queue - 하드 연도보다 소프트 시대 좌표가 우선한다
doc_type: reference
stage: reference
status: draft
evidence_role: provenance
depends_on:
  - qfuds_verse_zettel_soft_chronology_policy_ko
next_gate: process this queue card into an atomic permanent zettel or mark it as source-only
last_updated: 2026-07-07
---

# ZK Queue - 하드 연도보다 소프트 시대 좌표가 우선한다
...
- Source line: [line 15](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/00_continuity/911_zettel_soft_chronology_policy_ko.md)
- Heading level: `H1`
- Source heading: `하드 연도보다 소프트 시대 좌표가 우선한다`
