---
doc_id: zkqv_fcc5baa03ffc
title: ZK Queue - Shared World Canon (SSOT) — 이 선반이 보유
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - Shared World Canon (SSOT) — 이 선반이 보유
...
- Source line: [line 51](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/README.md)
- Heading level: `H2`
- Source heading: `Shared World Canon (SSOT) — 이 선반이 보유`
