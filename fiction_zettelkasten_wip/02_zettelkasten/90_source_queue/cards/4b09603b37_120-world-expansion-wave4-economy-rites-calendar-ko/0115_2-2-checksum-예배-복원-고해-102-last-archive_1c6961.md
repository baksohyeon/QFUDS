---
doc_id: srcidx_1c69616c81866752
title: "Source Index - 2.2 checksum 예배·복원 고해 (102 Last Archive)"
doc_type: reference
stage: reference
status: draft
...
# Source Index - 2.2 checksum 예배·복원 고해 (102 Last Archive)
...
- Source line: [line 115](../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/120_world_expansion_wave4_economy_rites_calendar_ko.md)
- Heading level: `H3`
- Source heading: `2.2 checksum 예배·복원 고해 (102 Last Archive)`
...
> - 라스트 아카이브 계열 예배는 말이 아니라 checksum으로 끝난다(102): "기억이 일치합니다 /
>   고통이 누락되지 않았습니다 / 동의 상태는 unknown입니다."
> - 복원 고해소·저해상 예배당(리미넬, 119 §1.1): 불완전 복원체를 위한 공동체 의식.
