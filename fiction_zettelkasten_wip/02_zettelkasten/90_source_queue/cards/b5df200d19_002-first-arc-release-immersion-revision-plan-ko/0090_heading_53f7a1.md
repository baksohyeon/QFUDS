---
doc_id: zkqv_53f7a164cdcd
title: ZK Queue - Before / After (보정의 결 — 예시)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - Before / After (보정의 결 — 예시)
...
- Source line: [line 90](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/30_revisions/002_first_arc_release_immersion_revision_plan_ko.md)
- Heading level: `H2`
- Source heading: `Before / After (보정의 결 — 예시)`
