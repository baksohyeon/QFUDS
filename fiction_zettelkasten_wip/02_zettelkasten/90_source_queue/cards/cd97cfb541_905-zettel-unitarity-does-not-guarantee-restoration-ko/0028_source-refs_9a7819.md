...
- Source line: [line 28](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/905_zettel_unitarity_does_not_guarantee_restoration_ko.md)
- Heading level: `H2`
- Source heading: `Source Refs`

## Parent Context

- H1: 유니터리는 실용적 복원을 보증하지 않는다
