...
depends_on:
  - qfuds_verse_zettel_crypto_anchor_reversal_ko
...
- Source line: [line 27](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/903_zettel_crypto_anchor_reversal_ko.md)
- Heading level: `H2`
- Source heading: `Source Refs`

## Parent Context

- H1: 암호는 처음엔 구원이고 나중엔 재앙이다
