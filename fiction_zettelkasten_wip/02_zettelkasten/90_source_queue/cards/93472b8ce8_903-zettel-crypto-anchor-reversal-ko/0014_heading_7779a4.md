---
doc_id: zkqv_7779a40a6472
title: ZK Queue - 암호는 처음엔 구원이고 나중엔 재앙이다
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - 암호는 처음엔 구원이고 나중엔 재앙이다
...
- Source line: [line 14](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/903_zettel_crypto_anchor_reversal_ko.md)
- Heading level: `H1`
- Source heading: `암호는 처음엔 구원이고 나중엔 재앙이다`
