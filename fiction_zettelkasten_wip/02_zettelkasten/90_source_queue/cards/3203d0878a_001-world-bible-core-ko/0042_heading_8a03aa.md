---
doc_id: zkqv_8a03aaf4bf4a
title: ZK Queue - 3. cross-layer bleed + 설명 절제 규칙
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - 3. cross-layer bleed + 설명 절제 규칙
...
- Source line: [line 42](../../../../../../../docs/wiki/fiction/10_universes/vector-sandbox/10_world/001_world_bible_core_ko.md)
- Heading level: `H2`
- Source heading: `3. cross-layer bleed + 설명 절제 규칙`
