---
doc_id: zkqv_d04f218eac14
title: ZK Queue - 4. 현재 reference가 화석이 되었는가
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - 4. 현재 reference가 화석이 되었는가
...
- Source line: [line 52](../../../../../../../docs/wiki/fiction/00_studio/006_prose_verisimilitude_audit_checklist_ko.md)
- Heading level: `H2`
- Source heading: `4. 현재 reference가 화석이 되었는가`
