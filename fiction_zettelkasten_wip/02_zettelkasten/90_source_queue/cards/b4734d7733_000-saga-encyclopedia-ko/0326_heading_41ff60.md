---
doc_id: zkqv_41ff60760d0a
title: ZK Queue - `10_story_design` — 아이디어·아웃라인·arc 지도·씬카드 (확정 전 설계)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - `10_story_design` — 아이디어·아웃라인·arc 지도·씬카드 (확정 전 설계)
...
- Source line: [line 326](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/000_saga_encyclopedia_ko.md)
- Heading level: `H3`
