---
doc_id: srcidx_a5b68046a502289b
title: "Source Index - `00_bible` — 확정된 세계 사실·인물·제도·과학 경계 (설정 기준서)"
doc_type: reference
stage: reference
status: draft
...
# Source Index - `00_bible` — 확정된 세계 사실·인물·제도·과학 경계 (설정 기준서)
...
- Source line: [line 502](../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/000_saga_encyclopedia_ko.md)
- Heading level: `H3`
