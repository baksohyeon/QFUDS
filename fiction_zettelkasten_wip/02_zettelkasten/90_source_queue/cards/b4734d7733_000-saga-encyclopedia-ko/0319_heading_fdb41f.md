---
doc_id: zkqv_fdb41fd1cafe
title: "ZK Queue - "QFUDS SAGA 단편 S1: 반려 버튼 (한국어 primary)" (queue)"
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - "QFUDS SAGA 단편 S1: 반려 버튼 (한국어 primary)" (queue)
...
- Source line: [line 319](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/20_series/qfuds-saga/000_saga_encyclopedia_ko.md)
- Heading level: `H4`
- Source heading: `["QFUDS SAGA 단편 S1: 반려 버튼 (한국어 primary)"](20_drafts/단편집/001_reject_button_korean_primary.md)`
