---
doc_id: zkqv_62d0f64f3a3a
title: ZK Queue - 관찰자 창구 원본 아카이브 (raw provenance)
doc_type: reference
stage: reference
status: draft
...
# ZK Queue - 관찰자 창구 원본 아카이브 (raw provenance)
...
- Source line: [line 15](../../../../../../../docs/wiki/fiction/10_universes/vector-sandbox/40_anthologies/feathersmcgraw-coda/20_drafts/000_raw_source_ko.md)
- Heading level: `H1`
- Source heading: `관찰자 창구 원본 아카이브 (raw provenance)`
