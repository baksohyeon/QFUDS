...
depends_on:
  - qfuds_verse_zettel_qday_as_authentication_crisis_ko
...
- Source line: [line 27](../../../../../../../docs/wiki/fiction/10_universes/qfuds-verse/10_world/907_zettel_qday_as_authentication_crisis_ko.md)
- Heading level: `H2`
- Source heading: `Source Refs`

## Parent Context

- H1: Q-Day는 유동성 위기가 아니라 인증 위기다
