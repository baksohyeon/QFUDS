...
- 감사 기준 **80개 문서** (연속성 5, 세계 24, bible 11, workroom 13, story_design 23,
  ...
  그래프 직접 산출. 이후 정합 작업으로 [124 원어 층](../world/124_far_future_native_lexicon_return_death_ko.md)이
...
| 문서 | 역할 | status |
| --- | --- | --- |
| [101 세계 기준점·핍진성](../world/101_world_anchor_and_verisimilitude_ko.md) | 현실 앵커와 그럴듯함의 경계 | draft |
| [103 Genesis Chain·복원 신화](../world/103_bitcoin_genesis_chain_and_restoration_myth_ko.md) | 비트코인 위상·복원 신화 기원 | draft |
| [105 암호학적 죽음·해시 계약](../world/105_cryptographic_death_and_hash_covenant_ko.md) | Q-Day 위에 선 약속들 | draft |
| [108 Cryptographic Death·암호 개념](../world/108_cryptographic_death_era_and_crypto_concepts_ko.md) | 암호 개념 상세 설정 | draft |
| [107 Last Archive 기원·역연산 인과](../world/107_last_archive_origin_and_reversal_causality_ko.md) | **키스톤.** Last Archive 기원·인과 구조 | draft |
| [113 복원 메커니즘 정정](../world/113_restoration_mechanism_correction_ko.md) | 복원=손실 사본(부활 아님) | draft |
| [114 in-world 물리(정보·유니터리)](../world/114_in_world_physics_information_unitarity_restoration_ko.md) | 원본 없음·복원 물리 근거(최상위 우선) | draft |
| [110 비트코인 위상·이념전쟁·심층시간](../world/110_bitcoin_stature_ideology_deeptime_ko.md) | 장기시간 유효성·이념전쟁 | draft |
| [111 세계관 컴펜디움](../world/111_world_compendium_codex_ko.md) | 세계 설정 종합 코덱스 | draft |

세력·문명사·제도 축:

| 문서 | 역할 | status |
| --- | --- | --- |
| [102 세력·문화·권력·생태계](../world/102_factions_cultures_power_ecology_ko.md) | 세력 생활권·이념·생태계 장부 | draft |
| [123 이기(理氣) 이념 축](../world/123_yi_gi_ideology_axis_ko.md) | 원본 실재 vs 부재 형이상학 축(candidate) | draft |
| [124 먼 미래 원어 층](../world/124_far_future_native_lexicon_return_death_ko.md) | 부활·복원 현대 gloss를 in-world 원어로 분리(candidate) | draft |
| [109 세력 명칭 Canon 확정](../world/109_factions_canon_naming_ko.md) | 세력 이름 canon(명칭 SSOT) | draft |
| [104 Post-AGI 문명사·이중언어 규약](../world/104_post_agi_civilization_history_bilingual_protocol_ko.md) | AGI 이후 문명사·한국어 우선 | draft |
| [112 AI·자동화·인간 확인 루프](../world/112_ai_automation_human_in_the_loop_ssot_ko.md) | 왜 사람이 도장을 찍나(제도 근거) | draft |
| [115 Q-Day 여파 타임라인과 세계](../world/115_qday_aftermath_timeline_and_world_ko.md) | Q-Day 여파(7인 패널 종합) | draft |
| [116 Q-Day 14도메인 매트릭스](../world/116_qday_world_system_14domain_matrix_ko.md) | 115 부속 14도메인 인과 매트릭스 | draft |
| [106 메타포 토대·독자 접근성](../world/106_reader_accessibility_and_real_world_anchors_ko.md) | 메인 메타포·검증 대장 | draft |

세계 확장 웨이브(candidate 대사전):

| 문서 | 역할 | status |
| --- | --- | --- |
| [117 웨이브 1](../world/117_world_expansion_wave1_names_places_events_ko.md) | 고유명사·지명·세력·인물·사건·어휘 | draft |
| [118 웨이브 2](../world/118_world_expansion_wave2_factions_relationships_ko.md) | 세력 내부 심화·관계망 | draft |
| [119 웨이브 3](../world/119_world_expansion_wave3_geography_event_chains_ko.md) | 지리·궤도·사건 연쇄 | draft |
| [120 웨이브 4](../world/120_world_expansion_wave4_economy_rites_calendar_ko.md) | 경제·통화·의례·달력 | draft |
| [121 웨이브 5](../world/121_world_expansion_wave5_language_tech_infra_ko.md) | 언어·기술 인프라 | draft |
| [122 웨이브 6 capstone](../world/122_world_expansion_wave6_ecology_education_media_index_ko.md) | 생태·교육·미디어·크로스 인덱스 | draft |
...
- [10_world/104 이중언어 프로토콜](../world/104_post_agi_civilization_history_bilingual_protocol_ko.md) (한국어 우선 규약)
- 기술어(hash·KDF·entropy·Page curve 등) 보존 규칙: [10_world/README](../world/README.md) Technical Rule 표.
